<?php
class Ms_users_Model extends CI_Model 
{
	
	private $table = 'ms_users';
	private $id    = 'user_id';
	...
	**/
	...
	{
		return $this->db->query("SELECT * FROM ".$this->table." WHERE user_name = '$username' AND user_password = '$password'");
	}
}
?>